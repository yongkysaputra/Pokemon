        ...
        children: <Widget>[
          Positioned(
            ...
            children: <Widget>[
              ...
              Text(pokemon.name,style: TextStyle(fontSize: 30.0, fontWeight: FontWeight.bold),),
              Text("Height: ${pokemon.height}",style: TextStyle(fontSize: 15.0),),
              Text("Weight: ${pokemon.weight}",style: TextStyle(fontSize: 15.0),),
              Text("Types",style: TextStyle(fontSize:15.0, fontWeight: FontWeight.bold),
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
